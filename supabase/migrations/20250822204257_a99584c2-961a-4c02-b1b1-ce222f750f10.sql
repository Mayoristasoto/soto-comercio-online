-- Corregir problemas de seguridad del linter

-- 1. Corregir la función para evitar mutable search path
...
-- 2. Eliminar la vista que causaba problemas de security definer
DROP VIEW IF EXISTS public.gondolas_public;

-- 3. Crear tabla de datos públicos en su lugar (más seguro)
