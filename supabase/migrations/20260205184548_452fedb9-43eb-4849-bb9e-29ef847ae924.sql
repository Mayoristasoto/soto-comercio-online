-- Corregir RPC para usar el nombre de columna correcto
...
BEGIN
  ...
  -- Obtener minutos permitidos del turno (usando nombre correcto de columna)
  SELECT COALESCE(ft.duracion_pausa_minutos, 30) INTO v_minutos_permitidos
