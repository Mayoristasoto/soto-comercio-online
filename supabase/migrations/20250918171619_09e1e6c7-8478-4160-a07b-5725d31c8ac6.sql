-- Unificar sistema de usuarios con empleados (con CASCADE)
-- Eliminar tabla profiles ya que empleados cumple esa función

-- Eliminar tablas de logs de profiles usando CASCADE
DROP TABLE IF EXISTS public.profile_access_log CASCADE;
DROP TABLE IF EXISTS public.profile_security_log CASCADE;
DROP TABLE IF EXISTS public.profile_access_audit CASCADE;

-- Eliminar funciones relacionadas con profiles usando CASCADE
