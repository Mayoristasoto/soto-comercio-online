-- Actualizar función para usar hash_pin existente en lugar de bcrypt
...
BEGIN
  ...
  -- Limpiar tabla temporal por si existe de una ejecución anterior
  DELETE FROM pins_generados;
