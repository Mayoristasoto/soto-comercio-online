-- Ajustar función detectar_exceso_pausa para registrar excesos desde 1 minuto
...
BEGIN
  ...
  IF exceso_minutos >= 1 THEN
    INSERT INTO fichajes_pausas_excedidas (
      ...
      (pausa_inicio_record.hora_inicio AT TIME ZONE 'America/Argentina/Buenos_Aires')::TIME,
      (NEW.timestamp_real AT TIME ZONE 'America/Argentina/Buenos_Aires')::TIME,
...
-- Crear función para recalcular pausas excedidas de un empleado
