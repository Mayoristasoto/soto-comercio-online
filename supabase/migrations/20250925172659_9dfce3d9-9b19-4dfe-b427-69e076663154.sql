-- SYSTEMATICALLY REMOVE ALL DEPENDENCIES OF current_user_is_admin()
-- First drop all policies that depend on this function, then recreate them safely

-- Drop all policies that depend on current_user_is_admin()
