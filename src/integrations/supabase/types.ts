    ...
    Tables: {
      ...
      checklist_control_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "checklist_control_items_punto_id_fkey"
            columns: ["punto_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "checklist_control_items_zona_id_fkey"
            columns: ["zona_id"]
            isOneToOne: false
      ...
      recorrido_hallazgos: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "recorrido_hallazgos_punto_id_fkey"
            columns: ["punto_id"]
            isOneToOne: false
            referencedRelation: "recorrido_puntos"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "recorrido_hallazgos_tarea_id_fkey"
            columns: ["tarea_id"]
            isOneToOne: false
      ...
      recorrido_puntos: {
        ...
        Relationships: [
          {
            foreignKeyName: "recorrido_puntos_zona_id_fkey"
            columns: ["zona_id"]
            isOneToOne: false
            referencedRelation: "recorrido_zonas"
            referencedColumns: ["id"]
      ...
      tareas_plantillas: {
        ...
        Relationships: [
          {
            foreignKeyName: "tareas_plantillas_categoria_id_fkey"
            columns: ["categoria_id"]
            isOneToOne: false
            referencedRelation: "tareas_categorias"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "tareas_plantillas_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "empleados"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      empleados_carga_trabajo: {
        Row: {
          ...
          sucursal_id: string | null
          sucursal_nombre: string | null
          tareas_completadas_semana: number | null
          tareas_en_progreso: number | null
          tareas_pendientes: number | null
          tareas_proximas_vencer: number | null
