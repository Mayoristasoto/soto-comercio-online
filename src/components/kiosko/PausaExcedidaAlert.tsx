...
export function PausaExcedidaAlert({
  ...
  return (
    <div className="fixed inset-0 bg-background/95 backdrop-blur-sm z-50 flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
      <Card 
        className={`
          w-[95%] max-w-[95%] sm:max-w-[90%] md:max-w-[85%] lg:max-w-3xl p-3 sm:p-5 md:p-6 lg:p-8 border-4 border-orange-500 shadow-2xl my-2
      ...
      >
        ...
        <div className="flex items-center justify-center mb-3 sm:mb-6">
          <div className="bg-orange-500/20 p-3 sm:p-5 md:p-6 rounded-full">
            <Clock className="w-10 h-10 sm:w-14 sm:h-14 md:w-20 md:h-20 text-orange-500 animate-pulse" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-1.5 sm:gap-3 md:gap-4 mb-3 sm:mb-6">
          <Card className="p-2 sm:p-3 md:p-4 bg-muted/50 border-border">
            <div className="flex flex-col items-center text-center">
              <div className="text-[10px] sm:text-xs md:text-sm text-muted-foreground mb-0.5 sm:mb-1">Tiempo usado</div>
              <div className="text-lg sm:text-2xl md:text-3xl font-bold text-foreground">{minutosUsados}</div>
          ...
          <Card className="p-2 sm:p-3 md:p-4 bg-muted/50 border-border">
            <div className="flex flex-col items-center text-center">
              <div className="text-[10px] sm:text-xs md:text-sm text-muted-foreground mb-0.5 sm:mb-1">Permitido</div>
              <div className="text-lg sm:text-2xl md:text-3xl font-bold text-foreground">{minutosPermitidos}</div>
              <div className="text-[10px] sm:text-xs md:text-sm text-muted-foreground">minutos</div>
            </div>
          </Card>
          
          <Card className="p-2 sm:p-3 md:p-4 bg-orange-500/10 border-orange-500/30">
            <div className="flex flex-col items-center text-center">
              <div className="text-[10px] sm:text-xs md:text-sm text-orange-600 mb-0.5 sm:mb-1">Exceso</div>
              <div className="text-lg sm:text-2xl md:text-3xl font-bold text-orange-600">+{minutosExceso}</div>
              <div className="text-[10px] sm:text-xs md:text-sm text-orange-600">minutos</div>
            </div>
          </Card>
        </div>
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-2 sm:gap-4">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="text-xs sm:text-sm text-foreground mb-2 sm:mb-3">
                Registrado en tu legajo como <strong className="text-destructive">Cruz Roja</strong> por exceso de pausa.
              </p>
